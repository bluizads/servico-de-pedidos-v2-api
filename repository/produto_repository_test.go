...
func TestProdutoReduzirEstoque_Sucesso(t *testing.T) {
	mock := novoMock(t)
	repo := NovoProdutoRepository(mock)
	...
	if err := repo.ReduzirEstoque(context.Background(), "1", 2); err != nil {
		t.Fatalf("erro inesperado: %v", err)
	}
}

func TestProdutoReduzirEstoque_Erro(t *testing.T) {
	mock := novoMock(t)
	repo := NovoProdutoRepository(mock)
...
func TestProdutoDevolverEstoque_Sucesso(t *testing.T) {
	mock := novoMock(t)
	repo := NovoProdutoRepository(mock)
	...
	if err := repo.DevolverEstoque(context.Background(), "1", 2); err != nil {
		t.Fatalf("erro inesperado: %v", err)
	}
}

func TestProdutoDevolverEstoque_Erro(t *testing.T) {
	mock := novoMock(t)
	repo := NovoProdutoRepository(mock)
